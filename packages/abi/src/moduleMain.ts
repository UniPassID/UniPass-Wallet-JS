export const abi = [
  ...
  },
  {
    inputs: [
      {
        internalType: "enum ITransaction.CallType",
        name: "",
        type: "uint8",
      },
    ],
  ...
  },
  {
    inputs: [
      {
        internalType: "enum ModuleHooks.HookActionType",
        name: "",
        type: "uint8",
      },
    ],
    name: "invalidHookActionType",
    type: "error",
  },
  {
    inputs: [
      {
        ...
        internalType: "struct ITransaction.Transaction",
        name: "",
        type: "tuple",
      },
      {
